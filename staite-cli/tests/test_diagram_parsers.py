...
from staite_cli.diagram.parsers.javascript import JavaScriptParser
from staite_cli.diagram.parsers.python import PythonParser
...
class TestPythonParser:
    ...
    def test_simple_import(self):
        deps = self.parser.extract_dependencies(Path("cli.py"), "import os\n")
        assert "os" in deps

    def test_from_import(self):
        deps = self.parser.extract_dependencies(Path("cli.py"), "from pathlib import Path\n")
        assert "pathlib" in deps

    def test_relative_import(self):
        deps = self.parser.extract_dependencies(Path("src/cli.py"), "from .utils import helper\n")
