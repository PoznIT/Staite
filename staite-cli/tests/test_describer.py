...
from staite_cli.describer import sentence_count, describe_files


class TestSentenceCount:
    def test_small_file(self):
        assert sentence_count(5) == 2

    def test_boundary_below_30(self):
        assert sentence_count(29) == 2

    def test_boundary_at_30(self):
        assert sentence_count(30) == 4

    def test_medium_file(self):
        assert sentence_count(100) == 4

    def test_boundary_below_150(self):
        assert sentence_count(149) == 4

    def test_boundary_at_150(self):
        assert sentence_count(150) == 6

    def test_large_file(self):
        assert sentence_count(500) == 6
